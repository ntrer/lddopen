<template>
  ...
  <el-page-header @back="goBack" class="my-header">
    ...
    <span slot="content" style="font-weight: bold;font-size: 16px;">新增活动方案</span>
  </el-page-header>
       ...
       <el-row>
         <el-col :span="20">
           ...
           <el-form-item label="价格" prop="price" class="lable-text ">
            ...
            <el-form-item label="方案文件" prop="activityProgramName" class="lable-text ">
              ...
              <el-upload class="upload-demo upload-file" :action="serverUrl" :on-remove="handleRemoveFile"
        ...
        <el-form-item label="器材介绍" prop="logoImgUrl" class="lable-text">
         ...
         <!--  <div>
            ...
            <imgUpload  ref="imageupload2" v-model="imgList2" :limit="9" :isShow="true" :uploadText="uploadText" :uploadIcon="uploadIcon"
            :isDisabled="true"  :width="120" :height="160" @preViewImage="preViewImage" @delIndex="delIndex" @click.native="chooseImage"></imgUpload>
  ...
  <div style="position: absolute;right: 50px;top: 20%;width: 280px;height: 550px; " class="view-bg" >
    ...
    <span style="margin-left: 24px;font-size: 13px;color: #bfbdc0;">{{activityIntroduce}}</span>
       ...
       <div style="display: flex;flex-direction: row;margin-top: -40px;">
        ...
        <div style="margin-top: 20px;" v-loading="loading">
          ...
          <pagination
            ...
            @pagination="getprovidersPosterList"
          />
...
<script>
  ...
  import {ActivityProgramClassification,providersPosterList,addActivityProgram,PosterClassification} from "@/api/content/content";
        ...
        onEditorChange({editor, html, text}) {//内容改变事件
         ...
         submitForm(){
           ...
           for (var i = 0; i < this.imgList2.length; i++) {
            ...
            addActivityProgram(this.form).then(response => {
              console.log(response)
