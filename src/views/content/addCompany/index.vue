<template>
  ...
  <el-page-header @back="goBack" class="my-header">
    ...
    <span slot="content" style="font-weight: bold;font-size: 16px;">新增厂商</span>
  </el-page-header>
      ...
      <el-row>
        <el-col :span="20">
          ...
          <el-form-item label="厂商名称" prop="manufactorName" class="lable-text">
            <el-input v-model="form.manufactorName" placeholder="请输入1-24个字的厂商名称" class="my-input" maxlength="24" @input="getName"/>
          </el-form-item>
          ...
          <el-form-item label="所在城市" prop="city" style="width: 100%;" class="lable-text">
            <div slot="label" style="display: flex;flex-direction: row;align-items: center;">
             <span>所在城市</span>
             <el-tooltip content="选择所在的城市地点" placement="top" style="margin-left: 10px;">
          ...
          <el-form-item label="简介" prop="activityProgramName" class="lable-text ">
            ...
            <el-input v-model="form.introduction" placeholder="请输入不超过500个字的厂商简介" class="my-input" type="textarea":rows="5" @input="getIntroduction"/>
          </el-form-item>
       ...
       <h5 style="font-weight: bold;">联系方式</h5>
        <el-form-item label="联系电话" prop="label" class="lable-text">
         <div slot="label" style="display: flex;flex-direction: row;align-items: center;">
          <span>联系方式</span>
          <el-tooltip content="最多可添加10个联系方式" placement="top" style="margin-left: 10px;">
             <i class="el-self-iconQuestion" style="font-size: 16px;color: #ccc;"></i>
          </el-tooltip>
         </div>
         <div id="rowform" >
           <div class="contact" v-for="(item, index) in manufactorContactss" :key="index" style="width: 74%; height: 40px; display: flex; align-items: center; margin-top: 5px;">
              ...
              <div style="width: 64%;display: flex;flex-direction: row;align-items: center;" class="contact-item">
                <div style="width: 20px;border: 1px solid rgba(0,0,0,.125);background-color: #f7f7f7;">
                  <el-tooltip content="拖动此处可调整顺序" placement="top" >
          ...
          <div style="width: 60%;margin-top: 5px;" v-if="this.manufactorContactss.length<10">
   ...
   <el-dialog :title="title" :visible.sync="openContact" width="500px" append-to-body>
     <el-form ref="contactForm" :model="contactForm" :rules="rules"  label-width="100px">
       ...
       <el-form-item label="名称" prop="contactsName" class="lable-text">
         <div slot="label" style="display: flex;flex-direction: row;align-items: center;">
          <span>名称</span>
          <el-tooltip content="同一厂商内唯一" placement="top" style="margin-left: 10px;">
             <i class="el-self-iconQuestion" style="font-size: 16px;color: #ccc;"></i>
          </el-tooltip>
         </div>
         <el-input v-model="contactForm.contactsName" placeholder="请输入2~8个字的名称" maxlength="8"  class="my-input2"/>
       </el-form-item>
       <el-form-item label="电话" prop="contactsMobile" class="lable-text">
         ...
         <el-input v-model="contactForm.contactsMobile" placeholder="请输入联系电话" maxlength="11"  class="my-input2"/>
       </el-form-item>
    ...
    <bottom-card moduleName="内容" pagesName="新增厂商" style="margin-top: 20px;"></bottom-card>
...
<script>
  ...
  import {addManufactor} from "@/api/content/manufactor";
    ...
    methods: {
      ...
      getIntroduction(value){
       ...
       submitContact(){
        ...
        if(this.isEdit){
           this.manufactorContactss[this.editIndex]=this.contactForm
        }else{
       ...
       addManufactor(this.form).then(response => {
         console.log(response)
       ...
       editContact(index){
         ...
         this.contactForm=this.manufactorContactss[index]
         this.openContact=true;
         this.title="修改联系方式"
       },
