<template>
  ...
  <el-page-header @back="goBack" class="my-header">
    ...
    <span slot="content" style="font-weight: bold;font-size: 16px;">新增海报</span>
  </el-page-header>
 ...
 <el-form-item label="分类" class="lable-text">
...
<script>
  import {PosterClassification,addPoster} from "@/api/content/content";
