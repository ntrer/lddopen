<template>
  ...
  <el-page-header @back="goBack" class="my-header">
    ...
    <span slot="content" style="font-weight: bold;font-size: 16px;">修改器材</span>
  </el-page-header>
...
<script>
  ...
  import {addProduct,industryClassification,productList,getIndustryProduct,editIndustryProduct,ManufactorList} from "@/api/content/tools";
...
const toolbarOptions = [
 ...
 ['clean']
  ...
  export default {
    ...
    created() {
      this.providersProductId = this.$route.query.data.providersProductId
      console.log(this.providersProductId)
    ...
    methods: {
      ...
      getData(){
        getIndustryProduct(this.providersProductId).then(response => {
          console.log(response)
          this.form=response.data
          if(response.data.topMark==0){
            this.isTop==0
          }
          else{
            this.isTop==1
          ...
          for (var i = 0; i < response.data.providersIndustryProductPublicityMapList.length; i++) {
              let data = {
                  url: response.data.providersIndustryProductPublicityMapList[i].fullProductImgUrl,
                  relative_url: response.data.providersIndustryProductPublicityMapList[i].productImgUrl
                }
                this.imgList.push(data)
          }

          this.toolsName=this.form.productName
      ...
      switchTop(index){
       ...
       this.form.providersProductId=this.providersProductId

       editIndustryProduct(this.form).then(response => {
         console.log(response)
