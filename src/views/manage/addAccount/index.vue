<template>
  <div class="app-container" style="padding: 20px;">
    ...
    <el-page-header @back="goBack" class="my-header">
      ...
      <span slot="content" style="font-weight: bold;font-size: 16px;">新增账号</span>
    </el-page-header>
       ...
       <el-row>
         <el-col :span="14">
           ...
           <el-form-item label="手机号" prop="activityProgramName" class="lable-text">
             <el-input v-model="form.activityProgramName" placeholder="请输入11位手机号,录入成功后该账号只能自己修改" maxlength="11" class="my-input" />
           </el-form-item>
